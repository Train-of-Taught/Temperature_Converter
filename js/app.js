//Input Elements
let tempInputField = document.getElementById("temp-input-field");
let convertScale = document.getElementById("convert-scale");
...
/*
1. When checked, it adds an event listener to the input field, running convert() for:
